...
for i=1:24
    ...
    %Equality constraint
    constraints=[constraints;sum(G(:,i))+sum(etaE.*THE(:,i))==sum(L(:,i))+sum(act(:,i).*LS)];
...
opt1=optimizer(constraints,J,options,[prova],{G,E,THT,THE,ETH,J,act});
% Optimizer launch:
